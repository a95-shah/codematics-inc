...
export default function AdminLogin() {
  ...
  return (
    <div className="min-h-screen bg-[#1B1D1F] flex items-center justify-center p-6 relative overflow-hidden font-body selection:bg-red-600/30">
      {/* Background Glow */}
      ...
      <div className="w-full max-w-md bg-[#232527] border border-white/5 p-12 lg:p-14 rounded-[2.5rem] shadow-2xl relative z-10">
         
         <div className="text-center mb-10">
            <h1 className="text-3xl font-black text-white tracking-tight font-heading">Admin <span className="text-[#c92228]">Login</span></h1>
         ...
         <form onSubmit={handleSubmit} className="space-y-6">
               ...
               <div className="space-y-2">
                  ...
                  <div className="relative">
                    ...
                    <input 
                      type="email" 
                      required 
                      className="w-full pl-12 pr-6 py-4 bg-[#1B1D1F] border border-white/5 rounded-2xl text-white font-bold focus:border-[#c92228] focus:ring-0 transition-all outline-none" 
               ...
               <div className="space-y-2">
                  ...
                  <div className="relative">
                    ...
                    <input 
                      type="password" 
                      required 
                      className="w-full pl-12 pr-6 py-4 bg-[#1B1D1F] border border-white/5 rounded-2xl text-white font-bold tracking-widest focus:border-[#c92228] focus:ring-0 transition-all outline-none" 
                      placeholder="••••••••"
                      value={password}
            ...
            <div className="pt-4">
               <button 
                 type="submit" 
                 disabled={loading}
                 className="w-full py-4 bg-[#c92228] text-white rounded-2xl text-sm font-bold shadow-lg hover:bg-[#a01b20] transition-all transform active:scale-95 disabled:bg-gray-700 flex items-center justify-center gap-3"
               >
         ...
         <div className="mt-8 pt-8 border-t border-white/5 flex flex-col items-center gap-6">
            <Link 
              href="/" 
              className="group flex items-center text-xs font-bold text-gray-400 hover:text-white transition-colors"
            >
