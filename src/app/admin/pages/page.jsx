          ...
          {pages.map((p) => (
            <button
              ...
              className={`w-full text-left px-5 py-4 rounded-xl border text-sm font-black transition-all ${
                selectedSlug === p.slug
                  ? 'bg-blue-600 text-white border-blue-600 shadow-xl shadow-blue-100 scale-105 z-10'
          ...
          {!selectedSlug ? (
            ...
            <form onSubmit={handleSubmit} className="space-y-10 animate-fade-in">
              ...
              <div className="flex items-center justify-between sticky bottom-4 bg-white/80 backdrop-blur-md p-6 rounded-2xl border border-blue-100 shadow-2xl z-20">
                ...
                <button type="submit" disabled={loading} className="px-12 py-4 bg-blue-600 text-white rounded-xl shadow-xl hover:bg-blue-700 transition-all font-black uppercase tracking-[0.1em] text-sm flex items-center active:scale-95 disabled:bg-gray-400">
