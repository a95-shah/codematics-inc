      ...
      <div className="flex justify-between items-end border-b border-gray-100 pb-6">
        ...
        {!isEditing && (
          <button 
            ...
            className="flex items-center px-6 py-3 bg-amber-600 text-white rounded-xl shadow-lg hover:bg-amber-700 transition-all font-bold text-sm uppercase tracking-widest"
          >
      ...
      <div className="bg-white p-10 rounded-2xl shadow-2xl border border-gray-100 mt-12 relative animate-fade-in shadow-amber-100">
        ...
        <form onSubmit={handleSubmit} className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="md:col-span-2 flex justify-end space-x-4 pt-4 border-t border-gray-100">
            ...
            <button type="submit" className="px-10 py-3 bg-amber-600 text-white rounded-xl shadow-xl hover:bg-amber-700 transition-all font-bold text-sm transform active:scale-95">Verify & Save</button>
          </div>
        </form>
      </div>
    </div>
