        ...
        <div className="text-center z-[1] px-6">
          ...
          >
            ...
            <div className="flex justify-center mb-6">
              <div className="w-20 h-20 rounded-2xl flex items-center justify-center text-[40px] text-red bg-[linear-gradient(135deg,rgba(201,34,40,0.15),rgba(201,34,40,0.05))]">
                {icon}
              </div>
            </div>
        ...
        <div className="container">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-[60px] items-center about-grid">
            ...
            <AnimatedSection direction="right">
              <div className="w-full aspect-square rounded-3xl border border-glass-border flex items-center justify-center bg-gradient-to-br from-bg-secondary to-bg-tertiary relative overflow-hidden">
                <div className="text-[120px] text-red opacity-20">{icon}</div>
