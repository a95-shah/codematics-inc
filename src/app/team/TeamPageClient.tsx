    ...
    <div className="bg-[#1B1D1F] min-h-screen font-body selection:bg-red-600/30">
      ...
      <section className="relative py-24 overflow-hidden">
        ...
        <div className="container mx-auto px-6 text-center z-10">
          <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }}>
            ...
            <h1 className="text-[clamp(2.5rem,5vw,4rem)] font-black mb-5 font-heading text-white">
      ...
      {leadership.length > 0 && (
        <section className="pb-20 container mx-auto px-6">
          <div className="mb-12 border-l-4 border-[#c92228] pl-6">
            <h2 className="text-3xl font-black text-white font-heading tracking-tight">Leadership</h2>
            <p className="text-gray-500 font-medium">The visionary leads guiding our mission.</p>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            {leadership.map((member, i) => (
              <TeamCard key={member._id} name={member.name} role={member.role} index={i} image={member.imageUrl} />
            ))}
          </div>
        </section>
      )}
      ...
      {team.length > 0 && (
        <section className="pb-32 container mx-auto px-6">
          <div className="mb-12 border-l-4 border-white/5 pl-6">
            <h2 className="text-3xl font-black text-white font-heading tracking-tight">Our Expert Team</h2>
      ...
      {/* Join CTA */}
      <section className="pb-32 container mx-auto px-6">
        <div className="bg-[#232527] p-16 rounded-[3rem] border border-white/5 shadow-2xl relative overflow-hidden group text-center">
          ...
          <div className="relative z-10">
            <h2 className="text-4xl font-black text-white mb-6 font-heading tracking-tight">
            ...
            <Link href="/contact" className="px-10 py-5 bg-[#c92228] text-white rounded-2xl font-bold shadow-xl hover:bg-[#a01b20] transition-all transform active:scale-95 inline-block">
              Get in Touch
            </Link>
          </div>
        </div>
