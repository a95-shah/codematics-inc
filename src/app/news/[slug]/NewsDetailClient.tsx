        ...
        <div className="container">
          <AnimatedSection>
            <div className="max-w-[800px] mx-auto">
              {/* Featured Image Area */}
              <div className="w-full h-[300px] md:h-[400px] rounded-2xl bg-gradient-to-br from-bg-tertiary to-bg-primary border border-glass-border flex items-center justify-center mb-10">
