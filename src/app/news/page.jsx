      ...
      <section className="relative py-24 overflow-hidden">
        ...
        <div className="container mx-auto px-6">
          <div className="max-w-3xl">
            ...
            <p className="text-gray-400 text-lg leading-relaxed font-medium border-l-2 border-white/10 pl-6">
      ...
      <section className="pb-32 container mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-16">
          {news.map((item) => (
            ...
            >
              <div className="relative aspect-[16/10] w-full rounded-[2.5rem] overflow-hidden mb-8 shadow-2xl transition-all duration-700 hover:shadow-red-600/10 border border-white/5 group-hover:border-red-600/20">
                {item.coverImage ? (
                  ...
                  <div className="w-full h-full bg-[#232527] flex items-center justify-center font-black text-3xl text-gray-800 tracking-tighter">
                    {item.category}
                  </div>
                )}
                <div className="absolute top-6 left-6 px-5 py-2 bg-[#c92228] text-white rounded-full text-[10px] font-bold tracking-widest shadow-xl">
                  {item.category}
                </div>
              </div>
              ...
              <div className="space-y-4 px-2">
                ...
                <h2 className="text-3xl font-black text-white tracking-tight group-hover:text-[#c92228] transition-colors leading-tight font-heading">
                  {item.title}
                </h2>
        ...
        {news.length === 0 && (
          <div className="text-center py-40 bg-white/5 rounded-[3rem] border border-dashed border-white/10">
            <h2 className="text-gray-600 text-lg font-bold tracking-[0.3em]">RECORDS ARE CURRENTLY VOID</h2>
          </div>
        )}
      </section>
    </div>
