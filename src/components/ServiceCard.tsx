...
export default function ServiceCard({ icon, title, description, index }: ServiceCardProps) {
  ...
  return (
    ...
    >
      ...
      <div className="w-14 h-14 rounded-xl flex items-center justify-center mb-5 text-[28px] text-red bg-[linear-gradient(135deg,rgba(201,34,40,0.15),rgba(201,34,40,0.05))]">
        {icon}
      </div>
